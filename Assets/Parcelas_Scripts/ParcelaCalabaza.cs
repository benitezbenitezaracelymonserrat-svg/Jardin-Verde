...
using UnityEngine;
public class ParcelaCalabaza : MonoBehaviour, IParcela, IParcelaConsultable
{
    ...
    private int[] estados; // 0 = vacio, 1 = semilla, 2 = creciendo, 3 = maduro
    private bool[] mostrandoCaja;
    void Start()
    {
        estados = new int[semillas.Length];
        mostrandoCaja = new bool[semillas.Length];
        ZonaCosechaNivel2.Preparar(this, cajas, "Calabaza");
        ActualizarTodo();
    }
    void ActualizarTodo()
    {
    ...
    public bool InteractuarSlot(int i, string herramienta)
    {
        ...
        else if (herramienta == "canasta" && estados[i] == 3)
        {
            ...
            Debug.Log("Cosechaste 1 calabaza!");
            return true;
        }
        return false;
    }
