...
public class ParcelaCebolla : MonoBehaviour, IParcela, IParcelaConsultable
{
    [Header("Estados de la cebolla")]
    ...
    void Start()
    {
        ...
        ZonaCosechaNivel2.Preparar(this, cajas, "Cebolla");
        ActualizarTodo();
    }
    ...
    public bool InteractuarSlot(int i, string herramienta)
    {
        ...
        if (herramienta == "canasta" && estados[i] == 3)
        {
            ...
            Debug.Log("Cosechaste 1 cebolla!");
            return true;
        }
